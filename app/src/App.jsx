    ...
    <>
      ...
      <div className="cultura_titulo">
        ...
        <p>
          ...
          pellentesque molestie leo, non pretium massa. Phasellus nibh magna,
          ultricies in leo sed, tempor malesuada libero. Nulla vehicula, mauris
          id scelerisque placerat, odio mi pellentesque purus, eu dignissim
          tellus odio non lorem.
        </p>
      </div>
        ...
        <Box sx={{ width: "100%" }}>
          <Grid container columnSpacing={10}>
            <Grid size={4}>
              ...
              <body className="valores_texto">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
                pellentesque molestie leo, non pretium massa. Phasellus nibh
                magna, ultricies in leo sed, tempor malesuada libero.Donec ut
                suscipit turpis. Aenean elit tortor, scelerisque eu pretium at,
                facilisis ut lorem.
              </body>
            </Grid>
            <Grid size={4}>
